...
namespace mapManager {
    ...
    protected:
        ...
        // ROS
        message_filters::Subscriber<sensor_msgs::msg::Image> depthSub_;
        message_filters::Subscriber<sensor_msgs::msg::PointCloud2> pointcloudSub_;
        message_filters::Subscriber<geometry_msgs::msg::PoseStamped> poseSub_;
        message_filters::Subscriber<nav_msgs::msg::Odometry> odomSub_;

        
        typedef message_filters::sync_policies::ApproximateTime<sensor_msgs::msg::Image, geometry_msgs::msg::PoseStamped> depthPoseSyncPolicy;
        std::shared_ptr<message_filters::Synchronizer<depthPoseSyncPolicy>> depthPoseSync_;
        
        typedef message_filters::sync_policies::ApproximateTime<sensor_msgs::msg::Image, nav_msgs::msg::Odometry> depthOdomSyncPolicy;
        std::shared_ptr<message_filters::Synchronizer<depthOdomSyncPolicy>> depthOdomSync_;
        
        typedef message_filters::sync_policies::ApproximateTime<sensor_msgs::msg::PointCloud2, geometry_msgs::msg::PoseStamped> pointcloudPoseSyncPolicy;
        std::shared_ptr<message_filters::Synchronizer<pointcloudPoseSyncPolicy>> pointcloudPoseSync_;
        
        typedef message_filters::sync_policies::ApproximateTime<sensor_msgs::msg::PointCloud2, nav_msgs::msg::Odometry> pointcloudOdomSyncPolicy;
        std::shared_ptr<message_filters::Synchronizer<pointcloudOdomSyncPolicy>> pointcloudOdomSync_;
        
        rclcpp::TimerBase::SharedPtr occTimer_;
        rclcpp::TimerBase::SharedPtr inflateTimer_;
        rclcpp::TimerBase::SharedPtr projPointsVisTimer_;
        rclcpp::TimerBase::SharedPtr visTimer_;
        rclcpp::TimerBase::SharedPtr mapVisTimer_;
        rclcpp::TimerBase::SharedPtr inflatedMapVisTimer_;
        rclcpp::TimerBase::SharedPtr map2DVisTimer_;
        ...
        rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr mapExploredPub_;
    ...
    public:
        ...
        static std::shared_ptr<occMap> create();
        ...
        // service
        bool checkCollision(const std::shared_ptr<map_manager::srv::CheckPosCollision::Request> req, std::shared_ptr<map_manager::srv::CheckPosCollision::Response> res);		

        // callback
        void depthPoseCB(const std::shared_ptr<const sensor_msgs::msg::Image> img, const std::shared_ptr<const geometry_msgs::msg::PoseStamped> pose);
		void depthOdomCB(const std::shared_ptr<const sensor_msgs::msg::Image> img, const std::shared_ptr<const nav_msgs::msg::Odometry> odom);
		void pointcloudPoseCB(const std::shared_ptr<const sensor_msgs::msg::PointCloud2> pointcloud, const std::shared_ptr<const geometry_msgs::msg::PoseStamped> pose);
		void pointcloudOdomCB(const std::shared_ptr<const sensor_msgs::msg::PointCloud2> pointcloud, const std::shared_ptr<const nav_msgs::msg::Odometry> odom);
        ...
        // Visualziation
        void visCB();
        void projPointsVisCB();
        void mapVisCB();
        void inflatedMapVisCB();
        void map2DVisCB();
        ...
        void getCameraPose(const std::shared_ptr<const geometry_msgs::msg::PoseStamped> pose, Eigen::Matrix4d& camPoseMatrix);
		void getCameraPose(const std::shared_ptr<const nav_msgs::msg::Odometry> odom, Eigen::Matrix4d& camPoseMatrix);
	...
	inline void occMap::getCameraPose(const std::shared_ptr<const geometry_msgs::msg::PoseStamped> pose, Eigen::Matrix4d& camPoseMatrix) {
	...
	inline void occMap::getCameraPose(const std::shared_ptr<const nav_msgs::msg::Odometry> odom, Eigen::Matrix4d& camPoseMatrix) {
		Eigen::Quaterniond quat;
